...
<table id="t01">
  ...
  var header = ["CPU", "Motherboard", "Memory", "GPU", "SSD", "HDD", "Case", "Power Supply", "price"];
  var price = 0;
            ...
            if(parsedData.length > 0) {
              ...
              parsedData.forEach((item, i) => {
                  ...
                  t.onclick = function() {
                    ...
                    cell = thead[header.indexOf(cate)]
                    cell.innerHTML = cate + " : ";
    ...
    function priceSearch(cate, sku) {
      $.ajax({
          ...
          tData[header.indexOf(cate)].innerHTML = data;
          price = 0;
          for(var i = 0; i < header.length -1; i++) {
            price += parseFloat(tData[i].innerHTML);
          }
          tData[header.indexOf("price")].innerHTML = price;
          }});
    }
